...
class MockitoSugarTest_213 extends AnyWordSpec with MockitoSugar with Matchers with ArgumentMatchersSugar with TableDrivenPropertyChecks with ScalaFutures {
  val scenarios = Table(
    ("testDouble", "foo", "baz"),
