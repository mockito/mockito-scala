...
#### 0.4.6
 - 2018-10-09 - [2 commits](https://github.com/mockito/mockito-scala/compare/v0.4.5...v0.4.6) by [Bruno Bonanno](https://github.com/bbonanno) - published to [![Bintray](https://img.shields.io/badge/Bintray-0.4.6-green.svg)](https://bintray.com/mockito/maven/mockito-scala/0.4.6)
 - Avoid failing mock creation when reflection to lookup by-name args fails [(#46)](https://github.com/mockito/mockito-scala/pull/46)
